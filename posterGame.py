...
class mainLoop:
    ...
    def update_image(self, data):
        ...
        poster = pygame.transform.scale(image, (self.window_width, self.window_height*(27/32)))
        # Using blit to copy content from one surface to other
        self.scrn.blit(poster,(0, self.window_height*(5/32)))
    ...
    def main_loop(self):
        ...
        twilight = pygame.transform.scale(twilight, (self.window_width - 10, (self.window_height-10)*(5/32)))
        poster = pygame.transform.scale(poster, (self.window_width - 20, self.window_height*(27/32)-20))
        # Using blit to copy content from one surface to other
        pygame.draw.rect(self.scrn, (255,255,255), (5,5,self.window_width - 10, self.window_height - 10), border_radius=12)
        self.scrn.blit(twilight,(5,5))
        self.scrn.blit(poster,(10, (self.window_height*(5/32)) + 10))
